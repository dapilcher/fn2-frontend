...
const PostCard = ({ post }) => {
  return (
    <li key={`post-${post.id}`} className="border-b border-grey-200 flex flex-col items-start md:grid md:grid-cols-2 gap-8 md:items-center pb-8">
      {post.headerImage?.image.url &&
        <Link href={`/p/${post.slug}`} className="col-span-1 hover:opacity-90">
          <Image
      ...
      <div className="col-span-1 flex flex-col align-start">
        <div className="">
